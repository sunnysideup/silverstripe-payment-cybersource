...
use Sunnysideup\PaymentCyberSource\CyberSourcePaymentRandomAmount;
use Sunnysideup\PaymentCyberSource\Forms\CustomerOrderStepForm;
...
class OrderStepAmountConfirmed extends OrderStep implements OrderStepInterface
{
    ...
    public function relevantPayments(Order $order)
    {
        return $order->Payments()->filter(
            [
                'ClassName' => CyberSourcePaymentRandomAmount::class,
